...
public class _0001__CreateConversationCollection {
    ...
    private static final String MEMBER_IDS_UPDATED_AT_INDEX = "memberIds_1_updatedAt_-1";
    private static final String CONVERSATION_ID_CREATED_AT_INDEX = "conversationId_1_createdAt_-1";
    ...
    public void apply(MongoTemplate mongoTemplate) {
        mongoTemplate.indexOps(CONVERSATIONS_COLLECTION)
                .createIndex(new Index().on("memberIds", Direction.ASC)
                        ...
                        .named(MEMBER_IDS_UPDATED_AT_INDEX));
        ...
        mongoTemplate.indexOps(MESSAGES_COLLECTION)
                .createIndex(new CompoundIndexDefinition(messageCompoundKeys)
                        .named(CONVERSATION_ID_CREATED_AT_INDEX));
    }

    @Rollback
    public void rollback(MongoTemplate mongoTemplate) {
        mongoTemplate.indexOps(CONVERSATIONS_COLLECTION).dropIndex(MEMBER_IDS_UPDATED_AT_INDEX);
        mongoTemplate.indexOps(MESSAGES_COLLECTION).dropIndex(CONVERSATION_ID_CREATED_AT_INDEX);
    }
}